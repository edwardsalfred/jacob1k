    ...
    <div id="main" data-framer-hydrate-v2="{&#34;routeId&#34;:&#34;augiA20Il&#34;,&#34;localeId&#34;:&#34;default&#34;,&#34;breakpoints&#34;:[{&#34;hash&#34;:&#34;72rtr7&#34;,&#34;mediaQuery&#34;:&#34;(min-width: 1200px)&#34;},{&#34;hash&#34;:&#34;1dy4dcp&#34;,&#34;mediaQuery&#34;:&#34;(min-width: 810px) and (max-width: 1199px)&#34;},{&#34;hash&#34;:&#34;f2wq4l&#34;,&#34;mediaQuery&#34;:&#34;(max-width: 809px)&#34;},{&#34;hash&#34;:&#34;he6zob&#34;,&#34;mediaQuery&#34;:&#34;(min-width: 1200px)&#34;},{&#34;hash&#34;:&#34;1rtwx6s&#34;,&#34;mediaQuery&#34;:&#34;(min-width: 810px) and (max-width: 1199px)&#34;},{&#34;hash&#34;:&#34;1jw10ax&#34;,&#34;mediaQuery&#34;:&#34;(max-width: 809px)&#34;}]}" data-framer-ssr-released-at="2025-07-23T07:48:11.716Z" data-framer-page-optimized-at="2025-07-28T11:21:02.869Z" data-framer-generated-page="">
      ...
      <div className="framer-i3OY7 framer-he6zob" data-layout-template="true" style={{minHeight: '100vh', width: 'auto'}}>
        ...
        <div data-framer-root="" className="framer-SE1iI framer-ujTCN framer-4DSQ7 framer-pec35 framer-72rtr7" style={{minHeight: '100vh', width: 'auto', display: 'contents'}}>
          ...
          <section className="framer-x1dgnz" data-framer-name="projects">
            <div className="framer-1lprqjf" data-framer-name="content">
              {/* $ */}
              <div className="ssr-variant hidden-1dy4dcp hidden-f2wq4l">
                <div className="framer-1fhqjkh-container">
                  <div className="framer-Pb7lB framer-Bdswg framer-pec35 framer-u9Eok framer-6403zz framer-v-6403zz" data-framer-name="Yes Link" style={{width: '100%'}}>
                    ...
                    <div className="framer-k578jg" style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: '0', '--extracted-r6o4lv': 'var(--token-da6cfa3b-4541-4c0f-899e-86c3f3559e26, rgb(255, 255, 255))', transform: 'none'}} data-framer-component-type="RichTextContainer">
                      <p className="framer-text framer-styles-preset-i3ioj7" data-styles-preset="e4XI1gL8_" style={{'--framer-text-color': 'var(--extracted-r6o4lv, var(--token-da6cfa3b-4541-4c0f-899e-86c3f3559e26, rgb(255, 255, 255)))'}}>
                        {/* $ */}
                        <a className="framer-text framer-styles-preset-1c6ncnn" data-styles-preset="vvwkuHhz5" href="./projects">                        See all
</a>
                        {/* /$ */}
                      </p>
                    </div>
              ...
              {/* /$ */}
              <div className="framer-13j5h2n">
                {/* $ */}
                <div className="framer-1doe0gs">
                  {/* $ */}
                  <div className="ssr-variant hidden-1dy4dcp hidden-f2wq4l">
                    <div className="framer-13rzp82-container">
                      {/* $ */}
                      <a className="framer-AzWv2 framer-Cmb46 framer-pec35 framer-1asf74o framer-v-1asf74o framer-1vcdmp9" data-framer-name="Default" style={{width: '100%', opacity: '1'}} href="./projects/pestorix">                      <div className="framer-14fz7w2-container">
                        {/* $ */}
                        <div style={{display: 'flex', placeContent: 'center', placeItems: 'center', width: '100%', height: '100%', padding: '0'}}>
                          <img style={{maxWidth: '100%', maxHeight: '100%', borderRadius: '12px', webkitUserDrag: 'none', userDrag: 'none', userSelect: 'none'}} src="https://framerusercontent.com/images/TJnuth9zlhrQj2TjJHrL5TXR71c.jpg" srcset="https://framerusercontent.com/images/TJnuth9zlhrQj2TjJHrL5TXR71c.jpg?scale-down-to=512 512w,https://framerusercontent.com/images/TJnuth9zlhrQj2TjJHrL5TXR71c.jpg?scale-down-to=1024 1024w,https://framerusercontent.com/images/TJnuth9zlhrQj2TjJHrL5TXR71c.jpg 1600w" alt="" data-framer-original-sizes="" sizes="(min-width: 1200px) 100vw, (min-width: 810px) and (max-width: 1199px) 100vw, (max-width: 809px) 100vw" />
                          <div style={{position: 'absolute', inset: '0', pointerEvents: 'none', borderRadius: '12px'}}>
                          </div>
                        </div>
                        {/* /$ */}
                      </div>
                      <div className="framer-1uolx43" data-framer-name="wrapper" style={{borderBottomLeftRadius: '12px', borderBottomRightRadius: '12px', borderTopLeftRadius: '12px', borderTopRightRadius: '12px'}}>
                        <div className="framer-16a3fnn" data-framer-name="wrapper">
                          <div className="framer-x2eomg" style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: '0', '--framer-link-text-color': 'rgb(0, 153, 255)', '--framer-link-text-decoration': 'underline', transform: 'none'}} data-framer-component-type="RichTextContainer">
                            <h3 className="framer-text framer-styles-preset-mgnp7g" data-styles-preset="DorUiGrSE">
                              Pestorix
                            </h3>
                          </div>
                          <div className="framer-1ics03k" style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: '0', '--framer-link-text-color': 'rgb(0, 153, 255)', '--framer-link-text-decoration': 'underline', transform: 'none'}} data-framer-component-type="RichTextContainer">
                ...
                <div className="framer-1doe0gs">
                  ...
                  <div className="ssr-variant hidden-1dy4dcp hidden-f2wq4l">
                    <div className="framer-13rzp82-container">
                      {/* $ */}
                      <a className="framer-AzWv2 framer-Cmb46 framer-pec35 framer-1asf74o framer-v-1asf74o framer-1vcdmp9" data-framer-name="Default" style={{width: '100%', opacity: '1'}} href="./projects/danzora">                      <div className="framer-14fz7w2-container">
                        {/* $ */}
                        <div style={{display: 'flex', placeContent: 'center', placeItems: 'center', width: '100%', height: '100%', padding: '0'}}>
                ...
                <div className="framer-1doe0gs">
                  ...
                  <div className="ssr-variant hidden-1dy4dcp hidden-f2wq4l">
                    <div className="framer-13rzp82-container">
                      {/* $ */}
                      <a className="framer-AzWv2 framer-Cmb46 framer-pec35 framer-1asf74o framer-v-1asf74o framer-1vcdmp9" data-framer-name="Default" style={{width: '100%', opacity: '1'}} href="./projects/didasko">                      <div className="framer-14fz7w2-container">
                        {/* $ */}
                        <div style={{display: 'flex', placeContent: 'center', placeItems: 'center', width: '100%', height: '100%', padding: '0'}}>
                          <img style={{maxWidth: '100%', maxHeight: '100%', borderRadius: '12px', webkitUserDrag: 'none', userDrag: 'none', userSelect: 'none'}} src="https://framerusercontent.com/images/KDAwLLZvMGOUn7QZQZkv3ZGdLw.jpg" srcset="https://framerusercontent.com/images/KDAwLLZvMGOUn7QZQZkv3ZGdLw.jpg?scale-down-to=512 512w,https://framerusercontent.com/images/KDAwLLZvMGOUn7QZQZkv3ZGdLw.jpg?scale-down-to=1024 1024w,https://framerusercontent.com/images/KDAwLLZvMGOUn7QZQZkv3ZGdLw.jpg 1600w" alt="" data-framer-original-sizes="" sizes="(min-width: 1200px) 100vw, (min-width: 810px) and (max-width: 1199px) 100vw, (max-width: 809px) 100vw" />
                          <div style={{position: 'absolute', inset: '0', pointerEvents: 'none', borderRadius: '12px'}}>
                          </div>
                        </div>
                        {/* /$ */}
                ...
                <div className="framer-1doe0gs">
                  ...
                  <div className="ssr-variant hidden-1dy4dcp hidden-f2wq4l">
                    <div className="framer-13rzp82-container">
                      {/* $ */}
                      <a className="framer-AzWv2 framer-Cmb46 framer-pec35 framer-1asf74o framer-v-1asf74o framer-1vcdmp9" data-framer-name="Default" style={{width: '100%', opacity: '1'}} href="./projects/harmonix">                      <div className="framer-14fz7w2-container">
                        {/* $ */}
                        <div style={{display: 'flex', placeContent: 'center', placeItems: 'center', width: '100%', height: '100%', padding: '0'}}>
                          <img style={{maxWidth: '100%', maxHeight: '100%', borderRadius: '12px', webkitUserDrag: 'none', userDrag: 'none', userSelect: 'none'}} src="https://framerusercontent.com/images/fyxmT2r3YhKnBjCO7aAQaBdIc.jpg" srcset="https://framerusercontent.com/images/fyxmT2r3YhKnBjCO7aAQaBdIc.jpg?scale-down-to=512 512w,https://framerusercontent.com/images/fyxmT2r3YhKnBjCO7aAQaBdIc.jpg?scale-down-to=1024 1024w,https://framerusercontent.com/images/fyxmT2r3YhKnBjCO7aAQaBdIc.jpg 1600w" alt="" data-framer-original-sizes="" sizes="(min-width: 1200px) 100vw, (min-width: 810px) and (max-width: 1199px) 100vw, (max-width: 809px) 100vw" />
                          <div style={{position: 'absolute', inset: '0', pointerEvents: 'none', borderRadius: '12px'}}>
                          </div>
                        </div>
                        {/* /$ */}
