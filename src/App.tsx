              ...
              <div className="ssr-variant hidden-f2wq4l">
                <div className="framer-1a7qf8j">
                  <div style={{position: 'absolute', borderRadius: 'inherit', top: '0', right: '0', bottom: '0', left: '0'}} data-framer-background-image-wrapper="true">
                    <video autoPlay loop muted playsInline preload="auto" src="/JacobHeroVideoFinal.mp4" style={{display: 'block', width: '100%', height: '100%', borderRadius: 'inherit', objectPosition: 'center top', objectFit: 'cover'}} />
                  </div>
                </div>
              </div>
